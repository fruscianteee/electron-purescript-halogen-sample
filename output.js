...
(function(exports) {
  ...
  var myButton = (function () {
      var render = function (state) {
          ...
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Hello PureScript \u30c8\u30b0\u30eb\u30dc\u30bf\u30f3"), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(label), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Toggle.create)) ])([ Halogen_HTML_Core.text(label) ]) ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Button line 66, column 10 - line 75, column 24: " + [ v.constructor.name ]);
      };
